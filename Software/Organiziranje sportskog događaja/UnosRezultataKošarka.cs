...
{
    public partial class UnosRezultataKošarka : Form
    {
        ...
        public UnosRezultataKošarka(int idUtakmice)
        {
            InitializeComponent();
            IdUtakmice = idUtakmice;
        }

        private void UnosRezultataKošarka_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            using (var context = new PI2231_DBEntities())
            {
                ...
                ukupnoPrekrsajTim1Txt.Text = StatIgraca.prekrsaj.ToString();
                ukupnoSkokTim1Txt.Text = StatIgraca.skok.ToString();
            }
        }
        ...
        private void dataGridView2_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            using (var context = new PI2231_DBEntities())
            {
                ...
                ukupnoPrekrsajTim2Txt.Text = StatIgraca.prekrsaj.ToString();
                ukupnoSkokTim2Txt.Text = StatIgraca.skok.ToString();
            }
        }
        ...
        private void dodajSkokTim1Btn_Click(object sender, EventArgs e)
        {
            var OdabraniIgrac = dataGridView1.CurrentRow.DataBoundItem as korisnik;
            using (var context = new PI2231_DBEntities())
            {
        ...
        private void smanjiSkokTim1Btn_Click(object sender, EventArgs e)
        {
            var OdabraniIgrac = dataGridView1.CurrentRow.DataBoundItem as korisnik;
            using (var context = new PI2231_DBEntities())
            {
        ...
        private void dodajSkokTim2Btn_Click(object sender, EventArgs e)
        {
            var OdabraniIgrac = dataGridView2.CurrentRow.DataBoundItem as korisnik;
            using (var context = new PI2231_DBEntities())
            {
        ...
        private void smanjiSkokTim2Btn_Click(object sender, EventArgs e)
        {
            var OdabraniIgrac = dataGridView2.CurrentRow.DataBoundItem as korisnik;
            using (var context = new PI2231_DBEntities())
            {
        ...
        private void dodajPrekrsajTim1Btn_Click(object sender, EventArgs e)
        {
            var OdabraniIgrac = dataGridView1.CurrentRow.DataBoundItem as korisnik;
            using (var context = new PI2231_DBEntities())
            {
                var sql = from s in context.statistika_igraca where s.igrac_id == OdabraniIgrac.id_korisnik select s;
                StatIgraca = sql.Single();
                StatIgraca.prekrsaj += 1;
                context.SaveChanges();
            }
        }

        private void dodajPrekrsajTim2Btn_Click(object sender, EventArgs e)
        {
            var OdabraniIgrac = dataGridView2.CurrentRow.DataBoundItem as korisnik;
            using (var context = new PI2231_DBEntities())
            {
        ...
        private void smanjiPrekrsajTim2Btn_Click(object sender, EventArgs e)
        {
            var OdabraniIgrac = dataGridView2.CurrentRow.DataBoundItem as korisnik;
            using (var context = new PI2231_DBEntities())
            {
        ...
        private void smanjiPrekrsajTim1Btn_Click(object sender, EventArgs e)
        {
            var OdabraniIgrac = dataGridView1.CurrentRow.DataBoundItem as korisnik;
            using (var context = new PI2231_DBEntities())
            {
