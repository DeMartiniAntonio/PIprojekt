...
{
    public partial class PregledKorisnickogRacunaModeratora : Form
    {
        private korisnik potrebanKorisnik;
        public PregledKorisnickogRacunaModeratora()
        {
            InitializeComponent();
        ...
        private void PregledKorisnickogRacunaModeratora_Load(object sender, EventArgs e)
        {
        }
        ...
        {
            UredivanjeKorisnickogRacunaModeratora form = new UredivanjeKorisnickogRacunaModeratora(potrebanKorisnik);
            form.ShowDialog();
            PopuniPodatke();
        }
    }
