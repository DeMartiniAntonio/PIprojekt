...
{
    public partial class UredivanjeKorisnickogRacunaKorisnik : Form
    {
        private korisnik Korisnik;
        public UredivanjeKorisnickogRacunaKorisnik(korisnik potreban)
        {
            InitializeComponent();
            Korisnik = potreban;
        }
        ...
        private void UredivanjeKorisnickogRacunaKorisnik_Load(object sender, EventArgs e)
        {
