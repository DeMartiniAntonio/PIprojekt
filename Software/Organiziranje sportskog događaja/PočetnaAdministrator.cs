...
namespace Organiziranje_sportskog_događaja
{
    ...
    public partial class PočetnaAdministrator : Form
    {
        
        

        public PočetnaAdministrator()
        {
            InitializeComponent();
        ...
        private void PočetnaAdministrator_Load(object sender, EventArgs e)
        {
            DohvatiIgrace();
            DohvatiTimove();
            DohvatiOrganizacije();
        ...
        {
            PregledKorisnickogRacunaAdministratora pregledRacuna = new PregledKorisnickogRacunaAdministratora();
